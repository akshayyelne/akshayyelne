...
| **Clinical Intelligence** | • **RAG Reasoning:** Patient-level clinical analysis.<br>• **Risk Profiling:** Identifying readmission factors.<br>• **Governance:** High-fidelity clinical safety focus. | ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat-square) ![Ollama](https://img.shields.io/badge/-Ollama-white?style=flat-square) | [📂 Repo](#) <br> [📄 **Clinical Safety Docs**](#) |
